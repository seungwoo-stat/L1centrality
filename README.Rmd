...
These measures can be extended to assess the prominence of a *group of vertices*: the group *L*<sub>1</sub> centrality and group *L*<sub>1</sub> prestige measures are developed for this purpose (Kang 2025).
...
You can install the development version (0.1.1.9000) of `L1centrality` via:
