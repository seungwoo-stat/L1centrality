...
Version 0.2.0 of this package is available on [CRAN](https://cran.r-project.org/package=L1centrality):
...
You can install the development version (0.2.0; currently equivalent to the CRAN version) of `L1centrality` via:
