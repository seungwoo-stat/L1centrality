...
Version 0.3.0 of this package is available on [CRAN](https://cran.r-project.org/package=L1centrality):
...
You can install the development version (0.3.0.9002) of `L1centrality` via:
